...
public class F5 implements Serializable
{
    ...
    private final static long serialVersionUID = 2877275796867530897L;
     ...
     * @param questionsName
     */
    public F5(String questionsName, String qCode, String formName) {
        super();
    ...
    public F5 withQuestionsName(String questionsName) {
        this.questionsName = questionsName;
        return this;
    }
    ...
    public F5 withQCode(String qCode) {
        this.qCode = qCode;
        return this;
    }
    ...
    public F5 withFormName(String formName) {
        this.formName = formName;
        return this;
    }
