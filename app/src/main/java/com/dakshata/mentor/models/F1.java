...
public class F1 implements Serializable
{
    ...
    private final static long serialVersionUID = 2553822200130306132L;
     ...
     * @param questionsName
     */
    public F1(String questionsName, String qCode, String formName) {
        super();
    ...
    public F1 withQuestionsName(String questionsName) {
        this.questionsName = questionsName;
        return this;
    }
    ...
    public F1 withQCode(String qCode) {
        this.qCode = qCode;
        return this;
    }
    ...
    public F1 withFormName(String formName) {
        this.formName = formName;
        return this;
    }
