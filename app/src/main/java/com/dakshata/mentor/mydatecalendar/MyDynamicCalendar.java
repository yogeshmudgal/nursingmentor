...
import com.dakshata.mentor.WorkplanSummaryActivity;
...
public class MyDynamicCalendar extends LinearLayout {
    ...
    private Button btn_workplan_summary;
...
//            strHeaderTextColor = a.getString(R.styleable.MyCalendar_headerTextColor);
        ...
        btn_workplan_summary = (Button) rootView.findViewById(R.id.btn_workplan_summary);

        btn_workplan_summary.setOnClickListener(new OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(context, WorkplanSummaryActivity.class);
...
//        tv_month_year.setTextColor(Color.parseColor(strHeaderTextColor));
    ...
    public void addEvent(String date, String startTime, String endTime, String name, String motherOrChild) {
        if (!TextUtils.isEmpty(date) && !TextUtils.isEmpty(startTime) && !TextUtils.isEmpty(endTime) && !TextUtils.isEmpty(name)) {
            String tmpDate = GlobalMethods.convertDate(date, AppConstants.sdfDate_New, AppConstants.sdfDate);
            AppConstants.eventList.add(new EventModel(tmpDate, startTime, endTime, name, motherOrChild));
        }
    }
...
//    -------------------------------------------------------------------------
    ...
    private void setMonthView(String sign) {
        ...
        recyclerView_month_view_below_events.setVisibility(View.GONE);
    ...
    private void setMonthViewWithBelowEvents(String sign) {
        ...
        ll_upper_part.setVisibility(View.VISIBLE);
        recyclerView_month_view_below_events.setVisibility(View.VISIBLE);
        ll_lower_part.setVisibility(View.GONE);
        ll_blank_space.setVisibility(View.GONE);
        ll_hours.setVisibility(View.GONE);
            ...
            public void onClick(Date date) {
                ...
                for (int i = 0; i < AppConstants.eventList.size(); i++) {
                    if (AppConstants.eventList.get(i).getStrDate().equals(AppConstants.sdfDate.format(date))) {
                        eventModelList.add(new EventModel(AppConstants.eventList.get(i).getStrDate(), AppConstants.eventList.get(i).getStrStartTime(), AppConstants.eventList.get(i).getStrEndTime(), AppConstants.eventList.get(i).getStrName(), AppConstants.eventList.get(i).getMotherOrChild()));
                    }
                }
