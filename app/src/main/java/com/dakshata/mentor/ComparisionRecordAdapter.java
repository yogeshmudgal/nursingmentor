...
public class ComparisionRecordAdapter extends RecyclerView.Adapter<ComparisionRecordAdapter.MyHolder> {
    View view;
    ...
    public ComparisionRecordAdapter(Context context, List<ListPojo> arrayList) {
    ...
    public MyHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        view= LayoutInflater.from(context).inflate(R.layout.list_item_sync_comparision,parent,false);
