...
public class MentoringPracticesRetrComparision extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.mentoring_practices_view_comparision);
    ...
    public void initViews() {
        ...
        radioGroup1_pre = (TextView) findViewById(R.id.mp_rg1_pre);
        radioGroup2_pre = (TextView) findViewById(R.id.mp_rg2_pre);
        radioGroup3_pre = (TextView) findViewById(R.id.mp_rg3_pre);
        radioGroup4_pre = (TextView) findViewById(R.id.mp_rg4_pre);
        radioGroup5_pre = (TextView) findViewById(R.id.mp_rg5_pre);
        radioGroup6_pre = (TextView) findViewById(R.id.mp_rg6_pre);
        radioGroup7_pre = (TextView) findViewById(R.id.mp_rg7_pre);
        radioGroup8_pre = (TextView) findViewById(R.id.mp_rg8_pre);
        radioGroup9_pre = (TextView) findViewById(R.id.mp_rg9_pre);
        radioGroup10_pre = (TextView) findViewById(R.id.mp_rg10_pre);
        radioGroup11_pre = (TextView) findViewById(R.id.mp_rg11_pre);
        radioGroup12_pre = (TextView) findViewById(R.id.mp_rg12_pre);
        radioGroup13_pre = (TextView) findViewById(R.id.mp_rg13_pre);
        radioGroup14_pre = (TextView) findViewById(R.id.mp_rg14_pre);
        radioGroup15_pre = (TextView) findViewById(R.id.mp_rg15_pre);
        radioGroup16_pre = (TextView) findViewById(R.id.mp_rg16_pre);
        radioGroup17_pre = (TextView) findViewById(R.id.mp_rg17_pre);
        radioGroup18_pre = (TextView) findViewById(R.id.mp_rg18_pre);
        radioGroup19_pre = (TextView) findViewById(R.id.mp_rg19_pre);
    }
...
//            String sessionID=sharedPreferences.getString("session","");
            ...
            if (cursorSessionId != null && cursorSessionId.getCount() > 1) {
                ...
                Cursor cursor_pre = sqLiteDatabase.query(TABLENAME6, new String[]{COL_SESSION, COL_ROLR, COL_LP, COL_GA, COL_PV, COL_AUA, COL_ACP, COL_CND, COL_AMTSL, COL_ENBC, COL_NR, COL_SCN, COL_PPH, COL_IMPE, COL_IMPO, COL_PP1, COL_DND, COL_DPPH, COL_DPE, COL_DNR}, COL_SESSION + "=?", new String[]{lastRecordSessionId}, null, null, null, null);
                if (cursor_pre != null && cursor_pre.getCount() > 0) {
                    cursor_pre.moveToFirst();
                    String col_1 = cursor_pre.getString(cursor_pre.getColumnIndex(COL_ROLR));
                    String col_2 = cursor_pre.getString(cursor_pre.getColumnIndex(COL_LP));
                    String col_3 = cursor_pre.getString(cursor_pre.getColumnIndex(COL_GA));
                    String col_4 = cursor_pre.getString(cursor_pre.getColumnIndex(COL_PV));
                    String col_5 = cursor_pre.getString(cursor_pre.getColumnIndex(COL_AUA));
                    String col_6 = cursor_pre.getString(cursor_pre.getColumnIndex(COL_ACP));
                    String col_7 = cursor_pre.getString(cursor_pre.getColumnIndex(COL_CND));
                    String col_8 = cursor_pre.getString(cursor_pre.getColumnIndex(COL_AMTSL));
                    String col_9 = cursor_pre.getString(cursor_pre.getColumnIndex(COL_ENBC));
                    String col_10 = cursor_pre.getString(cursor_pre.getColumnIndex(COL_NR));
                    String col_11 = cursor_pre.getString(cursor_pre.getColumnIndex(COL_SCN));
                    String col_12 = cursor_pre.getString(cursor_pre.getColumnIndex(COL_PPH));
                    String col_13 = cursor_pre.getString(cursor_pre.getColumnIndex(COL_IMPE));
                    String col_14 = cursor_pre.getString(cursor_pre.getColumnIndex(COL_IMPO));
                    String col_15 = cursor_pre.getString(cursor_pre.getColumnIndex(COL_PP1));
                    String col_16 = cursor_pre.getString(cursor_pre.getColumnIndex(COL_DND));
                    String col_17 = cursor_pre.getString(cursor_pre.getColumnIndex(COL_DPPH));
                    String col_18 = cursor_pre.getString(cursor_pre.getColumnIndex(COL_DPE));
                    String col_19 = cursor_pre.getString(cursor_pre.getColumnIndex(COL_DNR));
